...
class RequestResponseContentLength extends UndiciError {
  constructor (message) {
    super(message)
    Error.captureStackTrace(this, RequestResponseContentLength)
    this.name = 'RequestResponseContentLength'
    this.message = message || 'Request body length does not match content-length header'
    this.code = 'UND_ERR_REQUEST_CONTENT_LENGTH_MISMATCH'
  }
}

class ResponseContentLength extends UndiciError {
  constructor (message) {
    super(message)
    Error.captureStackTrace(this, ResponseContentLength)
    this.name = 'ResponseContentLength'
