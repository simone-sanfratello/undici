...
function mismatchResponseContentLength(kResponseContentLength, kResponseBodySize) {
  return kResponseBodySize > 0 && kResponseContentLength > 0 &&
    kResponseBodySize != kResponseContentLength
}
